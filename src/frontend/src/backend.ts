...
import type { CardUpdate as _CardUpdate, PokemonCard as _PokemonCard, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addCard(arg0: CardUpdate): Promise<PokemonCard> {
        if (this.processError) {
            try {
                const result = await this.actor.addCard(to_candid_CardUpdate_n8(this._uploadFile, this._downloadFile, arg0));
                return from_candid_PokemonCard_n10(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async analyzeCardImage(arg0: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.analyzeCardImage(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCollection(): Promise<Array<PokemonCard>> {
        if (this.processError) {
            try {
                const result = await this.actor.getCollection();
    ...
    async getVisionApiKey(): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.getVisionApiKey();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async removeCard(arg0: string): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async setVisionApiKey(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setVisionApiKey(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateCard(arg0: string, arg1: CardUpdate): Promise<PokemonCard> {
        if (this.processError) {
            try {
                const result = await this.actor.updateCard(arg0, to_candid_CardUpdate_n8(this._uploadFile, this._downloadFile, arg1));
                return from_candid_PokemonCard_n10(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_PokemonCard_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _PokemonCard): PokemonCard {
...
function from_candid_record_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        rarity: value.rarity,
        cardId: value.cardId,
        customValue: record_opt_to_undefined(from_candid_opt_n12(_uploadFile, _downloadFile, value.customValue)),
...
function from_candid_vec_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_PokemonCard>): Array<PokemonCard> {
    return value.map((x)=>from_candid_PokemonCard_n10(_uploadFile, _downloadFile, x));
}
function to_candid_CardUpdate_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: CardUpdate): _CardUpdate {
...
function to_candid_record_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        rarity: value.rarity,
        cardId: value.cardId,
        customValue: value.customValue ? candid_some(value.customValue) : candid_none(),
        condition: value.condition
    };
}
